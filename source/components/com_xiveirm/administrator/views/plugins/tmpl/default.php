...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_xiveirm&task=plugins.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_xiveirm&view=plugins'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<table class="table table-striped" id="pluginList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<?php if (isset($this->items[0]->state)): ?>
						<td class="center">
							<?php echo JHtml::_('jgrid.published', $item->state, $i, 'plugins.', $canChange, 'cb'); ?>
						</td>
					<?php endif; ?>
					<td>
						<a href="<?php echo JRoute::_('index.php?option=com_xiveirm&task=plugin.edit&id=' . $item->id); ?>">
							<?php
