...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_xiveirm&task=options.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'optionList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<form action="<?php echo JRoute::_('index.php?option=com_xiveirm&view=options'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="optionList">
			<thead>
				<tr>
				...
				<th class='left'>
				<?php echo JHtml::_('grid.sort',  'COM_XIVEIRM_OPTIONS_OPT_VALUE', 'a.opt_value', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<td>
					<?php echo NFWItemHelper::getTitleById('viewlevel', $item->access); ?>
				</td>
