...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-vehicle').submit(function(event){
...
<div class="vehicle-edit front-end-edit">
    ...
    <form id="form-vehicle" action="<?php echo JRoute::_('index.php?option=com_xivetranscorder&task=vehicle.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_xivetranscorder&task=vehicle.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

            <input type="hidden" name="option" value="com_xivetranscorder" />
            <input type="hidden" name="task" value="vehicleform.save" />
