			...
			<?php if(JFactory::getUser()->authorise('core.create','com_xiveirm')): ?>
				...
				<span class="span5">
					<span class="pull-right">
						<a class="btn btn-small btn-primary pull-right inline" href="<?php echo JRoute::_('index.php?task=contact.edit&id=0'); ?>" data-rel="tooltip" data-placement="left" title data-original-title="<?php echo JText::_("COM_XIVEIRM_ADD_ITEM"); if(isset($addLastName)) { echo ' ' . $addLastName; } ?>"><i class="icon-plus"></i></a>
					</span>
				</span>
			<?php endif; ?>
		</h1>
		...
		<table id="table_report" class="table table-striped table-bordered table-hover dataTable" aria-describedby="table_report_info">
			...
			<?php foreach ($this->items as $item) : ?>
				...
				<tr>
					...
					<td class=" ">
						<a href="<?php echo JRoute::_('index.php?task=contact.edit&id='.$item->id); ?>">
							<?php 
					...
					<td class=" ">
						...
						<div class="hidden-desktop visible-phone">
							...
							<form id="form-contact-state-<?php echo $item->id ?>" style="display:inline" action="<?php echo JRoute::_('index.php?option=com_xiveirm&task=contact.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
								...
								<input type="hidden" name="jform[company]" value="<?php echo $item->company; ?>" />
								...
								<input type="hidden" name="jform[address_region]" value="<?php echo $item->address_region; ?>" />
							...
							<form id="form-contact-delete-<?php echo $item->id; ?>" style="display:inline" action="<?php echo JRoute::_('index.php?option=com_xiveirm&task=contact.remove'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
								<input type="hidden" name="jform[id]" value="<?php echo $item->id; ?>" />
								<input type="hidden" name="jform[client_id]" value="<?php echo $item->client_id; ?>" />
								<input type="hidden" name="jform[parent_id]" value="<?php echo $item->parent_id; ?>" />
								<input type="hidden" name="jform[state]" value="<?php echo (int)!((int)$item->state); ?>" />
