...
<script type="text/javascript">
    ...
    {
        if(task == 'tabapp.cancel'){
            Joomla.submitform(task, document.getElementById('tabapp-form'));
        }
        else{
            
            if (task != 'tabapp.cancel' && document.formvalidator.isValid(document.id('tabapp-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_xiveirm&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="tabapp-form" class="form-validate">
    <div class="row-fluid">
