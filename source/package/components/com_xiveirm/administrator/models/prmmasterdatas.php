 ...
 */
class Mc3prmModelprmmasterdatas extends JModelList
{
    ...
    public function __construct($config = array())
    {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'address_house_no', 'a.address_house_no',
                'zip', 'a.zip',
                'country', 'a.country',
                'phone', 'a.phone',
                'mobile', 'a.mobile',
                ...
                'supervisor_desc', 'a.supervisor_desc',
                'email', 'a.email',
                'web', 'a.web',
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__mc3_prm_masterdata` AS a');
