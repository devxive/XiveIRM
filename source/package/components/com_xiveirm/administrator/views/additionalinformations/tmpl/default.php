...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_xiveirm&task=additionalinformations.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_xiveirm&view=additionalinformations'); ?>" method="post" name="adminForm" id="adminForm">
