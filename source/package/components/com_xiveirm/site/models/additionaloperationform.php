 ...
 * Xiveirm model.
 */
class XiveirmModelAdditionaloperationForm extends JModelForm
{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_xiveirm.additionaloperation', 'additionaloperationform', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	{
		$data = JFactory::getApplication()->getUserState('com_xiveirm.edit.additionaloperation.data', array());
        if (empty($data)) {
            $data = $this->getData();
        }
