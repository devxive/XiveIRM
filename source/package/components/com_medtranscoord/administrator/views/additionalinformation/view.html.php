 ...
 * View to edit
 */
class MedtranscoordViewAdditionalinformation extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_MEDTRANSCOORD_TITLE_ADDITIONALINFORMATION'), 'additionalinformation.png');
