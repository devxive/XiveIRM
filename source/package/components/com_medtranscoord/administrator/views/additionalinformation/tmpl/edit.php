...
<form action="<?php echo JRoute::_('index.php?option=com_medtranscoord&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="additionalinformation-form" class="form-validate">
    <div class="row-fluid">
