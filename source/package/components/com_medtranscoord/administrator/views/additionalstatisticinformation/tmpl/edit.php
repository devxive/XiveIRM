...
<script type="text/javascript">
    ...
    {
        if(task == 'additionalstatisticinformation.cancel'){
            Joomla.submitform(task, document.getElementById('additionalstatisticinformation-form'));
        }
        else{
            
            if (task != 'additionalstatisticinformation.cancel' && document.formvalidator.isValid(document.id('additionalstatisticinformation-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_medtranscoord&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="additionalstatisticinformation-form" class="form-validate">
    <div class="row-fluid">
