...
<div class="order-edit front-end-edit">
    ...
    <form id="form-order" action="<?php echo JRoute::_('index.php?option=com_medtranscoord&task=order.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
			...
			<div class="control-group">
				<?php $canState = false; ?>
					<?php $canState = $canState = JFactory::getUser()->authorise('core.edit.state','com_medtranscoord'); ?>				<?php if(!$canState): ?>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_medtranscoord&task=order.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
