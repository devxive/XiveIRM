 ...
 */
class XivetranscorderViewTabapps extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		XivetranscorderHelper::addSubmenu('tabapps');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_XIVETRANSCORDER_TITLE_TABAPPS'), 'tabapps.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_xivetranscorder&view=tabapps');
		...
		JHtmlSidebar::addFilter(
			...
			'filter_catid',
			JHtml::_('select.options', JHtml::_('category.options', 'com_xivetranscorder.tabapps.catid'), "value", "text", $this->state->get('filter.catid'))
	...
	protected function getSortFields()
	{
		...
		'a.client_id' => JText::_('COM_XIVETRANSCORDER_TABAPPS_CLIENT_ID'),
		'a.access' => JText::_('COM_XIVETRANSCORDER_TABAPPS_ACCESS'),
		'a.plugin' => JText::_('COM_XIVETRANSCORDER_TABAPPS_PLUGIN'),
		'a.catid' => JText::_('COM_XIVETRANSCORDER_TABAPPS_CATID'),
