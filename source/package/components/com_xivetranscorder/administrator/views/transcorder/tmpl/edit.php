...
<script type="text/javascript">
    ...
    {
        if(task == 'transcorder.cancel'){
            Joomla.submitform(task, document.getElementById('transcorder-form'));
        }
        else{
            
            if (task != 'transcorder.cancel' && document.formvalidator.isValid(document.id('transcorder-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_xivetranscorder&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="transcorder-form" class="form-validate">
    <div class="row-fluid">
