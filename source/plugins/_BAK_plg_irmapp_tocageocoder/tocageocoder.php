...
/**
 * @package     IRM.Plugin
 * @subpackage  IRMApp.tocageocoder
 *
...
class PlgIrmAppTocageocoder extends JPlugin
{
	/**
	 * Stores the app name
	 * @var	appKey
	...
	public function onBeforeContent( &$item = null, &$params = null )
	{
		...
		NFWGeoGmap3::initMap();
		JHtml::_('script', 'plugins/irmapp/tocageocoder/assets/js/geo-helper.js', false, false, false, false);
...
//				});
	...
	{
		$googleMapIcon = '/plugins/irmapp/tocageocoder/assets/img/googlemaps-icon.png';
		...
		<script>
			 ...
			 */
			jQuery('.tocageocoder_tabbutton').click(function() {
